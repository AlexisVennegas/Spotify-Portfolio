import { c as createComponent, m as maybeRenderHead, e as addAttribute, r as renderTemplate, h as createAstro, g as renderComponent, f as renderTransition } from '../chunks/astro/server_CwJBoAYP.mjs';
import 'kleur/colors';
import { P as Projects, E as Education, C as Cantantes, S as Skills, f as ContactoData, $ as $$Layout, I as Information, a as $$Navigator, b as $$AsideList, c as $$AsideLibrary, d as $$Thumb, e as $$VolumenControl } from '../chunks/VolumenControl_CylTHsNB.mjs';
import 'clsx';
/* empty css                                */
...
const $$List = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(`containerData ${item.album}`, "class")} data-astro-cid-kkksmmij> <div class="" data-astro-cid-kkksmmij> ${index + 1} </div> <div class="" data-astro-cid-kkksmmij> <picture data-astro-cid-kkksmmij> <img${addAttribute(item.imageUrl, "src")}${addAttribute(item.title, "alt")} data-astro-cid-kkksmmij> </picture> <div class="information" data-astro-cid-kkksmmij> <h3 class="song-title" data-astro-cid-kkksmmij>${item.title}</h3> <p class="description" data-astro-cid-kkksmmij>${item.description}</p> </div> </div> <div class=""${addAttribute(`albumInformation albumInformation-${item.album}`, "id")} data-astro-cid-kkksmmij> ${item.album} </div> <div class="" data-astro-cid-kkksmmij> <div data-astro-cid-kkksmmij> ${item.yt ? renderTemplate`<a${addAttribute(`${item.yt}`, "href")} target="_blank" data-astro-cid-kkksmmij> <img src="./yt.png" alt="logo de youtube" data-astro-cid-kkksmmij> </a>` : null} </div> <div data-astro-cid-kkksmmij> ${item.github ? renderTemplate`<a${addAttribute(`${item.github}`, "href")} target="_blank" data-astro-cid-kkksmmij> <img src="./github.png" alt="logo de github" data-astro-cid-kkksmmij> </a>` : null} </div> </div> <div class="" data-astro-cid-kkksmmij> ${item.time} </div> </div> `;
...
const Slider = ({ id }) => {
  ...
  const showSlides = () => {
    return images.map((src, index) => /* @__PURE__ */ jsx(
      "div",
      {
        className: `slide ${index === slideIndex ? "active" : ""}`,
        children: /* @__PURE__ */ jsx("img", { src, alt: `Slide ${index + 1}` })
      },
      index
    ));
  };
...
const MailJs2 = ({ index, item }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "form-container", children: [
    ...
    /* @__PURE__ */ jsxs("form", { className: "form-data", onSubmit: sendEmail, children: [
      ...
      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("picture", { className: "pictureStyle", children: valueName ? /* @__PURE__ */ jsx("p", { children: valueName }) : /* @__PURE__ */ jsx("img", { src: item.img, alt: "" }) }) }),
